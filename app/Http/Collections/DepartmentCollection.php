...
class DepartmentCollection extends Collection
{
    ...
    {
        /* `$carry` and `$item` allows you to show all items in the collection, `$carry` used to carry the result of the last iteration to the next iteration...for more info...https://riptutorial.com/laravel/example/12397/using-reduce--#:~:text=Laravel%20Using%20reduce()&text=The%20reduce%20method%20reduces%20the,result%20to%20the%20next%20iteration. */
