...
class LogsController extends Controller
{
    ...
    /* The most common use case for logs is to act as a semi-disposable record of things that have happened that you may care about later, but to which you do not definitively need programmatic access, The logs are more about learning what's going on in the app and less about creating structured data your app can consume */
    ...
    public function writingLogs()
    {
        ...
        /* Like many other aspects of Laravel [file storage, database, email, etc] you can configure your logs to use one or more predefined log types, which you define in the config file */

        /* The single channel writes every log entry to a single file, that you have defined in the `config/logging.php` file */
