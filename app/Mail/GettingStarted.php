...
class GettingStarted extends Mailable implements ShouldQueue
{
    use Queueable, SerializesModels;

    // public properties are automatically made available to the email view
    ...
    public function build()
    {
        ...
        `text` method to pass a plain-text version.

        `attach` attaches a file from a raw string this method has also another form to pass more options like file type and new name.

        `attachData` attaches a file from a raw string this method has another form also to pass more options like attach method.
