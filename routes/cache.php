...
/* Within your Laravel app’s code, you can cache items to improve the website’s performance. As an example, imagine you have the following query >> Cache::remember('users', 120, function() {
...
Route::get('cachesIndex', [CacheController::class, 'index']);
