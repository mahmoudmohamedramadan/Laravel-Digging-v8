...
class DuskTest extends DuskTestCase
{
    ...
    public function testDuskMethods()
    {
        $this->browse(function (Browser $browse) {
            /* returns the text of any input if only one parameter is passed; sets the value of an input if a second param is passed */
            $browse->value('selector', 'value');

            /* gets the text content of a non fillable item like a <div> or <span> */
            ...
            /* With methods like `type` that target inputs, Dusk will start by tring to match a Dusk or CSS selector will look for an input with the provided name and fnally will try to find a <textarea> with the provided name */
            ...
            /* sends keypress events within the context of a selector according to the instructions in instructions, you can even combine modifiers with your typing */
